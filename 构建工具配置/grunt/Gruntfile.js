module.exports = function(grunt){
	...
	grunt.initConfig({
        ...
        uglify:{
            ...
            release: {
                files: {
                	'dist/js/lib.js': ['src/js/jquery-1.12.4.js', 'src/js/doT.js', 'src/js/util.js', 'src/js/wow.js', 'src/js/slick.min.js', 'src/js/jquery.singlePageNav.min.js']
                }
            }
        },
        ...
        less: {
        	production: {
        		...
        		files: {
        			...
        			'src/css/common.css': 'src/less/common.less'
        		}
        	}
    	},
